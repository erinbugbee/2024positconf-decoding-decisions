...
::: v-center-container
![](images/survey.png){fig-align="center" height="175"} 
![](images/choice.png){fig-align="center" height="175"}

::: {style="position: absolute; top: 85%; left: 8%; transform: translate(-50%, -50%);"}
{{< fa brain size=2x >}} {{< fa trophy size=2x >}}
:::
:::
:::
...
![](images/fig-reward-block-1.png){fig-align="center" height="550"}
...
-   If this is your [first]{.fragment .highlight-red} posit::conf...

    -   There are lots of new people, technologies, topics to learn

-   If you have attended [many]{.fragment .highlight-red} times before....

    -   You likely have made connections, know which sessions are of interest

## Keep Exploring {{< fa search >}}

-   Be careful of over-exploiting your knowledge

-   Meet new people, learn new things, see a new place {{< fa hiking >}}

# Resources

## Resources

[bit.ly/decoding-decisions2024](https://bit.ly/decoding-decisions2024)
